...
static int mpu6050_release(struct inode,struct file *file)
{
	return 0;
}
...
struct file_operation mpu6050_fops = {
	.owner		= THIS_MODULE,
	.open		= mpu6050_open,
